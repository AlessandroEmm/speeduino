...
#define TPSAE_ABSOLUTE_THRESHOLD 1 //TPS absolute threshold for when AE based idle control will engage, This equates to 2% throttle movement once the 0.5% resolution is applied
